...
export function ShareButtons({ productName }: ShareButtonsProps) {
  ...
  const shareLinks = {
    ...
    twitter: `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Mira este producto: ${productName}`)}&url=${encodeURIComponent(url)}`,
  }
  ...
  return (
    <div className="mt-6">
      <p className="font-semibold text-[#111111] mb-3">Compartir:</p>
      <div className="flex gap-3">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="w-10 h-10 rounded-full bg-[#000000] flex items-center justify-center hover:opacity-80 transition-opacity"
        >
          <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
